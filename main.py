...
    # 🔥 Ініціалізуємо атрибут всередині функції (це правильно)
...
    # 🔥 ВАЖЛИВО: Використання dev-сервера Flask для запуску.
    # Це є ПРИЧИНОЮ попередження, яке ви бачили раніше,
    # але дозволить запустити застосунок без Gunicorn.
    
